         ...
         <div class="top tp_marginlg">
        	...
        	<div class="hr"></div>
				...
				<a href="http://sharingdreams.co/<?php echo $id_perfil; ?>/page/1/<?php echo $usuario_perfil; ?>/">
					...
					<div class="txtg" style="margin-top:20px;"><?php $nome_perfil = str_replace("\\", "", $nome_perfil); echo $nome_perfil; ?></div>
				...
				<div class="gallery">
		            ...
		            <form method="GET" action="/enviar.php">
		                <center>
		                    ...
		                    <input type="submit" class="search-button-after" value="">
		                </center>
		            </form>
                    ...
                    $arte_nome_id = str_replace("/", "-", $arte_nome_id);?>
						...
						<center class="pages_box pages_box_profile">
			                <?php
			                    if ($pagina_atual > 1) {
			                        echo "<div class='page-button'><a id='num-page-final' href='/$id_perfil/page/".($pagina_atual - 1)."/$usuario_perfil'><<</a></div>";
			                    }
			                    ...
			                    for($i = $inicio; $i <= $limite + 1; $i++) {
			                        if ($i == $pagina_atual) {
			                            ...
			                            if ($i >= 1 && $i <= $numPaginas) {
			                                echo "<div class='page-button'><a  id='num-page' href='/$id_perfil/page/$i/$usuario_perfil'>".$i."</a></div> ";
			                            }
			                        }
			                    }
