...
<html>
	...
	<body>
        ...
        <div class="hr"></div>
		<center>
		<div class="txtg" style="margin-top:20px;">Change your password</div>
		...
		<form method='POST'>
			...
			<fieldset class="fieldLogin">
				...
				<label>
					<input type='password' name='pass1' id="usernameLogin" placeholder="Your new password">
				</label>
				<label>
					<input type='password' name='pass2' id="usernameLogin" placeholder="Confirm your new password">
